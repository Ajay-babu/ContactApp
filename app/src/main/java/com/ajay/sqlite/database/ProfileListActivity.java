        ...
        switch (item.getItemId()){
            case R.id.item_create_profile:
                ...
                profileBinding.btnCreateProfile.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        adapter.insertData(ProfileListActivity.this, profileBinding.etFirstName.getText().toString(), profileBinding.etLastName.getText().toString(), profileBinding.etContactNumber.getText().toString(), profileBinding.etContactEmail.getText().toString(), profileBinding.etContactAddress.getText().toString(), imageInBase64);
                        dialog.dismiss();
                        loadDataInListview();
                    }
                });
...
//            String contactNumber.getString(2)
//            String contactEmail.getString(3)
//            String  contactAddress.getString(4)
//            String image = cursor.getString(3);
                ...
                studentData.setContactNumber(cursor.getString(3));
                studentData.setContactEmail(cursor.getString(4));
                studentData.setContactAddress(cursor.getString(5));
                studentData.setImage(cursor.getString(6));
                studentDataList.add(studentData);
//            Log.d("DATA1", rowId+" "+fName+" "+lName+" "contactNumber+contactEmail+
//            " "+contactAddress+" "+image);
    ...
    public boolean onContextItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.item_update_record:
                ...
                profileBindingUpdate.etContactEmail.setText(cursor.getString(4));
                profileBindingUpdate.etContactAddress.setText(cursor.getString(5));
                ...
                profileBindingUpdate.btnCreateProfile.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (imageInBase64 == null){
                            ...
                            adapter.updateRecord(ProfileListActivity.this, profileBindingUpdate.etFirstName.getText().toString(), profileBindingUpdate.etLastName.getText().toString(), profileBindingUpdate.etContactNumber.getText().toString(),
                                    profileBindingUpdate.etContactEmail.getText().toString(), profileBindingUpdate.etContactAddress.getText().toString(),
                                    imageInBase64, cursor.getString(0));
                            dialog.dismiss();
                            loadDataInListview();
                        }
                    }
