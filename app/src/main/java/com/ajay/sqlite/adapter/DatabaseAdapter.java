...
public class DatabaseAdapter {
    private final String DB_NAME = "AppsSquadz";
    ...
    private final String CONTACT_ADDRESS = "contactAddress";
    private final String IMAGE = "image";

    // CREATE TABLE STUDENTS (rowId Integer AUTOINCREAMENT PRIMARY KEY, firstName text, lastName text, image text);
    private String sqlQuery = "CREATE TABLE "+TABLE_NAME+" ("+ROW_ID+" "+"INTEGER PRIMARY KEY AUTOINCREMENT"+", "+FIRST_NAME+" text"+", "+LAST_NAME+" text"+","+CONTACT_NUMBER+" INTEGER"+","+CONTACT_EMAIL+" text"+","+CONTACT_ADDRESS+" text"+", "+IMAGE+" text"+")";
    ...
    public void insertData(Context context, String firstName, String lastName, String contactNumber, String contactEmail, String contactAddress, String image){
        ContentValues contentValues = new ContentValues();
        contentValues.put(FIRST_NAME, firstName);
        contentValues.put(LAST_NAME, lastName);
        contentValues.put(CONTACT_NUMBER, contactNumber);
        contentValues.put(CONTACT_EMAIL, contactEmail);
        contentValues.put(CONTACT_ADDRESS, contactAddress);
    ...
    public Cursor getAllData(){
        String[] colList = new String[]{ROW_ID, FIRST_NAME, LAST_NAME, CONTACT_NUMBER,
                CONTACT_EMAIL, CONTACT_ADDRESS, IMAGE};
    ...
    public void updateRecord(Context context, String firstName, String lastName, String contactNumber, String contactEmail, String contactAddress, String image, String rowId){
        ContentValues contentValues = new ContentValues();
        contentValues.put(FIRST_NAME, firstName);
        contentValues.put(LAST_NAME, lastName);
        contentValues.put(CONTACT_NUMBER, contactNumber);
